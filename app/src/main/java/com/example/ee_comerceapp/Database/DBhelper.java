package com.example.ee_comerceapp.Database;
...
public class DBhelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase MyDB) {
        ...
        MyDB.execSQL("create table products(product_id INT primary key, coffeimage BLOB , product_name TEXT ,product_price INT,product_details TEXT)");
